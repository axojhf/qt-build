...
[CmdletBinding()]
param(
    $QtSrcUrl = "https://download.qt.io/official_releases/qt/6.4/6.4.0/single/qt-everywhere-src-6.4.0.zip",
    $QtStaticDir = "C:\QtStaticMingw64", # NO TRAILING SLASH
    $QtVersion = "6.4.0", #If you change this, you'll need to change the URL above to download as well...
